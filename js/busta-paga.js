...
(function (glob) {
  ...
  function addizionaleRegionale(imponibile, codReg, aliqManuale) {
    ...
    if (d.startsWith('detraz:')) imposta -= parseFloat(d.slice(7));   // Bolzano
